...
// Ensure, that EventRepositoryMock does implement repositories.EventRepository.
// If this is not the case, regenerate this file with moq.
var _ repositories.EventRepository = &EventRepositoryMock{}

// EventRepositoryMock is a mock implementation of repositories.EventRepository.
//
//     func TestSomethingThatUsesEventRepository(t *testing.T) {
//
//         // make and configure a mocked repositories.EventRepository
//         mockedEventRepository := &EventRepositoryMock{
//             AddSubscriberFunc: func(handler repositories.EventHandler)  {
...
//         }
//
//         // use mockedEventRepository in code that requires repositories.EventRepository
...
type EventRepositoryMock struct {
	...
	calls struct {
		...
		AddSubscriber []struct {
			...
			Handler repositories.EventHandler
		}
...
func (mock *EventRepositoryMock) AddSubscriber(handler repositories.EventHandler) {
