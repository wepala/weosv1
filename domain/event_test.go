...
func TestNewBasicEvent(t *testing.T) {
	event := domain.NewBasicEvent("TEST_EVENT", "1iNqlx5htN0oJ3viyfWkAofJX7k", nil, "1iNqoXV2UJojRhMPJtaL3E5DKXZ")
...
func TestEvent_IsValid(t *testing.T) {
	...
	t.Run("no entity id, event invalid", func(t *testing.T) {
		event := domain.NewBasicEvent("TEST_EVENT", "", nil, "1iNqoXV2UJojRhMPJtaL3E5DKXZ")
		if event.IsValid() {
