...
// Ensure, that EventRepositoryMock does implement weosv1.EventRepository.
// If this is not the case, regenerate this file with moq.
var _ weosv1.EventRepository = &EventRepositoryMock{}

// EventRepositoryMock is a mock implementation of weosv1.EventRepository.
//
// 	func TestSomethingThatUsesEventRepository(t *testing.T) {
//
// 		// make and configure a mocked weosv1.EventRepository
...
// 			},
// 			GetByAggregateFunc: func(ID string) ([]*weosv1.Event, error) {
// 				panic("mock out the GetByAggregate method")
// 			},
// 			GetByAggregateAndSequenceRangeFunc: func(ID string, start int64, end int64) ([]*weosv1.Event, error) {
// 				panic("mock out the GetByAggregateAndSequenceRange method")
// 			},
// 			GetByAggregateAndTypeFunc: func(ID string, entityType string) ([]*weosv1.Event, error) {
// 				panic("mock out the GetByAggregateAndType method")
// 			},
// 			GetByEntityAndAggregateFunc: func(entityID string, entityType string, rootID string) ([]*weosv1.Event, error) {
// 				panic("mock out the GetByEntityAndAggregate method")
// 			},
// 			GetSubscribersFunc: func() ([]weosv1.EventHandler, error) {
// 				panic("mock out the GetSubscribers method")
// 			},
// 			MigrateFunc: func(ctx context.Context) error {
// 				panic("mock out the Migrate method")
// 			},
// 			PersistFunc: func(ctxt context.Context, entity weosv1.AggregateInterface) error {
// 				panic("mock out the Persist method")
// 			},
// 		}
//
// 		// use mockedEventRepository in code that requires weosv1.EventRepository
...
type EventRepositoryMock struct {
	...
	calls struct {
		...
		Persist []struct {
			...
			Entity weosv1.AggregateInterface
		}
	}
...
func (mock *EventRepositoryMock) AddSubscriber(handler weosv1.EventHandler) {
...
func (mock *EventRepositoryMock) GetByAggregate(ID string) ([]*weosv1.Event, error) {
...
func (mock *EventRepositoryMock) GetByAggregateAndSequenceRange(ID string, start int64, end int64) ([]*weosv1.Event, error) {
...
func (mock *EventRepositoryMock) GetByAggregateAndType(ID string, entityType string) ([]*weosv1.Event, error) {
...
func (mock *EventRepositoryMock) GetByEntityAndAggregate(entityID string, entityType string, rootID string) ([]*weosv1.Event, error) {
...
func (mock *EventRepositoryMock) GetSubscribers() ([]weosv1.EventHandler, error) {
...
func (mock *EventRepositoryMock) Persist(ctxt context.Context, entity weosv1.AggregateInterface) error {
...
// Ensure, that ProjectionMock does implement weosv1.Projection.
// If this is not the case, regenerate this file with moq.
var _ weosv1.Projection = &ProjectionMock{}

// ProjectionMock is a mock implementation of weosv1.Projection.
//
// 	func TestSomethingThatUsesProjection(t *testing.T) {
//
// 		// make and configure a mocked weosv1.Projection
...
// 		}
//
// 		// use mockedProjection in code that requires weosv1.Projection
// 		// and then make assertions.
//
// 	}
...
func (mock *ProjectionMock) GetEventHandler() weosv1.EventHandler {
...
// Ensure, that LogMock does implement weosv1.Log.
// If this is not the case, regenerate this file with moq.
var _ weosv1.Log = &LogMock{}

// LogMock is a mock implementation of weosv1.Log.
//
// 	func TestSomethingThatUsesLog(t *testing.T) {
//
// 		// make and configure a mocked weosv1.Log
// 		mockedLog := &LogMock{
...
// 		}
//
// 		// use mockedLog in code that requires weosv1.Log
// 		// and then make assertions.
//
// 	}
type LogMock struct {
...
// Ensure, that DispatcherMock does implement weosv1.Dispatcher.
// If this is not the case, regenerate this file with moq.
var _ weosv1.Dispatcher = &DispatcherMock{}

// DispatcherMock is a mock implementation of weosv1.Dispatcher.
//
// 	func TestSomethingThatUsesDispatcher(t *testing.T) {
//
// 		// make and configure a mocked weosv1.Dispatcher
// 		mockedDispatcher := &DispatcherMock{
// 			AddSubscriberFunc: func(command *weosv1.Command, handler weosv1.CommandHandler) map[string][]weosv1.CommandHandler {
// 				panic("mock out the AddSubscriber method")
// 			},
// 			DispatchFunc: func(ctx context.Context, command *weosv1.Command) error {
// 				panic("mock out the Dispatch method")
// 			},
// 			GetSubscribersFunc: func() map[string][]weosv1.CommandHandler {
// 				panic("mock out the GetSubscribers method")
// 			},
// 		}
//
// 		// use mockedDispatcher in code that requires weosv1.Dispatcher
// 		// and then make assertions.
//
// 	}
type DispatcherMock struct {
	...
	calls struct {
		...
		AddSubscriber []struct {
			...
			Command *weosv1.Command
			// Handler is the handler argument value.
			Handler weosv1.CommandHandler
		}
...
// AddSubscriber calls AddSubscriberFunc.
func (mock *DispatcherMock) AddSubscriber(command *weosv1.Command, handler weosv1.CommandHandler) map[string][]weosv1.CommandHandler {
	if mock.AddSubscriberFunc == nil {
...
func (mock *DispatcherMock) Dispatch(ctx context.Context, command *weosv1.Command) error {
...
// GetSubscribers calls GetSubscribersFunc.
func (mock *DispatcherMock) GetSubscribers() map[string][]weosv1.CommandHandler {
	if mock.GetSubscribersFunc == nil {
...
// Ensure, that ApplicationMock does implement weosv1.Application.
// If this is not the case, regenerate this file with moq.
var _ weosv1.Application = &ApplicationMock{}

// ApplicationMock is a mock implementation of weosv1.Application.
//
// 	func TestSomethingThatUsesApplication(t *testing.T) {
//
// 		// make and configure a mocked weosv1.Application
// 		mockedApplication := &ApplicationMock{
// 			AddProjectionFunc: func(projection weosv1.Projection) error {
// 				panic("mock out the AddProjection method")
// 			},
// 			ConfigFunc: func() *weosv1.ApplicationConfig {
...
// 			},
// 			DispatcherFunc: func() weosv1.Dispatcher {
// 				panic("mock out the Dispatcher method")
// 			},
// 			EventRepositoryFunc: func() weosv1.EventRepository {
...
// 			},
// 			LoggerFunc: func() weosv1.Log {
// 				panic("mock out the Logger method")
// 			},
// 			MigrateFunc: func(ctx context.Context) error {
// 				panic("mock out the Migrate method")
// 			},
// 			ProjectionsFunc: func() []weosv1.Projection {
...
// 		}
//
// 		// use mockedApplication in code that requires weosv1.Application
// 		// and then make assertions.
//
// 	}
...
func (mock *ApplicationMock) AddProjection(projection weosv1.Projection) error {
...
func (mock *ApplicationMock) Config() *weosv1.ApplicationConfig {
...
func (mock *ApplicationMock) Dispatcher() weosv1.Dispatcher {
...
func (mock *ApplicationMock) EventRepository() weosv1.EventRepository {
...
func (mock *ApplicationMock) Logger() weosv1.Log {
...
func (mock *ApplicationMock) Projections() []weosv1.Projection {
